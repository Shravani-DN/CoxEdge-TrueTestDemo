...
"Step 7: Perform input and div actions"

WebUI.takeScreenshot()

performInputAndDivActions.execute(data_path_0, Integer.valueOf(index_0))

"Step 8: Add ipv4 rules and submit actions"

WebUI.takeScreenshot()

addIpv4RulesSubmitActions.execute(data_path_1, Integer.valueOf(index_1))

"Step 9: Click on button 'Firewall' -> Navigate to page 'service/manage-workloads/*/compute-cloud/automation/networks'"
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC24-Verify Network Management in Service Workloads with Firewall Rules_visual_checkpoint')
