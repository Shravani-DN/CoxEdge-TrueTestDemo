...
testObj = findTestObject('AI-Generated/Page_service_manage-workloads_compute-cloud_snapshots/div_object')
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC9-Verify successful navigation to Manage Workloads page in Edge Compute V2 Comp environment after clicking on multiple div_visual_checkpoint')
