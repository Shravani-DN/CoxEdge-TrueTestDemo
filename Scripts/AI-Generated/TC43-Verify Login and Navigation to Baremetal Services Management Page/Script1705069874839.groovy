...
testObj = findTestObject('AI-Generated/Page_services_baremetal-services/span_object')
...
'step 5: Add visual checkpoint at Page environment bare-metal baremetal-services man'

WebUI.takeFullPageScreenshotAsCheckpoint('TC43-Verify Login and Navigation to Baremetal Services Management Page_visual_checkpoint')
