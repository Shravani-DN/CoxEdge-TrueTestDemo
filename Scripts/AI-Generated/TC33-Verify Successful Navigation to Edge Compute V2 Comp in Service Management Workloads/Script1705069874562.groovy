...
testObj = findTestObject('AI-Generated/Page_service_manage-workloads_compute-cloud_storage/div_object_1')
...
'step 5: Add visual checkpoint at Page service manage-workloads edge-compute-v2 comp'

WebUI.takeFullPageScreenshotAsCheckpoint('TC33-Verify Successful Navigation to Edge Compute V2 Comp in Service Management Workloads_visual_checkpoint')
