...
WebUI.navigateToUrl(GlobalVariable.application_domain + '/service/manage-dns/stackpath-cox-uat/regression/2254e0d4-7fc8-48a9-9f2c-2ed004a2bf55')
...
testObj = findTestObject('AI-Generated/Page_service_manage-dns_stackpath-cox-uat_regression/p_object')
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC30-Verify Successful Navigation to Stackpath Cox UAT Regression in Service Management DNS_visual_checkpoint')
