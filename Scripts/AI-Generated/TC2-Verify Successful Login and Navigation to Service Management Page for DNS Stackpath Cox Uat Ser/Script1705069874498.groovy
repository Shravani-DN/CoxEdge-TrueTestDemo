...
testObj = findTestObject('AI-Generated/Page_home/button_object_4')
...
'step 4: Add visual checkpoint at Page service manage-dns stackpath-cox-uat ser'

WebUI.takeFullPageScreenshotAsCheckpoint('TC2-Verify Successful Login and Navigation to Service Management Page for DNS Stackpath Cox Uat Ser_visual_checkpoint')
