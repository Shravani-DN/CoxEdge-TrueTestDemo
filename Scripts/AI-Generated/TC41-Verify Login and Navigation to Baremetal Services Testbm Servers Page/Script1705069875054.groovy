...
testObj = findTestObject('AI-Generated/Page_services_baremetal-services/div_object_1')
...
'step 5: Add visual checkpoint at Page services baremetal-services testbm servers'

WebUI.takeFullPageScreenshotAsCheckpoint('TC41-Verify Login and Navigation to Baremetal Services Testbm Servers Page_visual_checkpoint')
