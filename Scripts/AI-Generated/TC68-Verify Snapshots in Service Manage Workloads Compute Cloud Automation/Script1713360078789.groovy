...
WebUI.verifyElementPresent(findTestObject('AI-Generated/Page_service_manage_workloads_compute_cloud_automation_snapshots/input_object'), 20, FailureHandling.CONTINUE_ON_FAILURE)
...
WebUI.setText(findTestObject('AI-Generated/Page_service_manage_workloads_compute_cloud_automation_snapshots/input_object'), input_object)
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC68-Verify Snapshots in Service Manage Workloads Compute Cloud Automation_visual_checkpoint')
