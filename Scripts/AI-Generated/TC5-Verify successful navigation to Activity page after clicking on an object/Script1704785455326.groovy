...
'step 6: Add visual checkpoint at Page activity'

WebUI.takeFullPageScreenshotAsCheckpoint('TC5-Verify successful navigation to Activity page after clicking on an object_visual_checkpoint')
