...
testObj = findTestObject('AI-Generated/Page_home/button_object_6')
...
testObj = findTestObject('AI-Generated/Page_reporting_organization/div_object')
...
WebUI.verifyMatch(WebUI.getUrl(), '.*/reporting/organization/?(?:#.*)?(?:\\?.*)?$', true)
...
testObj = findTestObject('AI-Generated/Page_reporting_your-invoice-view/p_object')
...
WebUI.verifyMatch(WebUI.getUrl(), '.*/reporting/your-invoice-view/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(testObj)

'step 9: Add visual checkpoint at Page reporting your-invoice-viewc6440-3f1c-42b2-9d'

WebUI.takeFullPageScreenshotAsCheckpoint('TC19-Verify Successful Login and Navigation to Your Invoice View in Reporting_visual_checkpoint')
