...
testObj = findTestObject('AI-Generated/Page_services_baremetal-services/button_object')
...
'step 5: Add visual checkpoint at Page environment add-environment bare-metal bareme'

WebUI.takeFullPageScreenshotAsCheckpoint('TC4-Verify Successful Login and Navigation to Add Environment Bare Metal Bareme_visual_checkpoint')
