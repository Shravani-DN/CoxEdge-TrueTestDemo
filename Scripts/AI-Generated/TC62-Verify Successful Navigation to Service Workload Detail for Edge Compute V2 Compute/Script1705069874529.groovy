...
testObj = findTestObject('AI-Generated/Page_service_workload-detail_compute-cloud_firewall/button_object_4')
...
'step 8: Add visual checkpoint at Page service workload-detail edge-compute-v2 compu'

WebUI.takeFullPageScreenshotAsCheckpoint('TC62-Verify Successful Navigation to Service Workload Detail for Edge Compute V2 Compute_visual_checkpoint')
