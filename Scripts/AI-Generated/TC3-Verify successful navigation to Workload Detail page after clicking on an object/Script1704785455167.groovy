...
'step 5: Add visual checkpoint at Page service workload-detail edge-compute-v2 compu'

WebUI.takeFullPageScreenshotAsCheckpoint('TC3-Verify successful navigation to Workload Detail page after clicking on an object_visual_checkpoint')
