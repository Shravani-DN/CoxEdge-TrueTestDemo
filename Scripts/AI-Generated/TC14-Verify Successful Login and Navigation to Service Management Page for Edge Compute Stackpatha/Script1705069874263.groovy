...
testObj = findTestObject('AI-Generated/Page_home/button_object_3')
...
testObj = findTestObject('AI-Generated/Page_service_manage-workloads_edge-compute_stackpath-cox-uat_ser/div_object')
...
WebUI.verifyMatch(WebUI.getUrl(), '.*/service/manage-workloads/edge-compute/stackpath-cox-uat/ser/workload/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(testObj)

'step 8: Add visual checkpoint at Page service manage-workloads edge-compute stackpa'

WebUI.takeFullPageScreenshotAsCheckpoint('TC14-Verify Successful Login and Navigation to Service Management Page for Edge Compute Stackpatha_visual_checkpoint')
