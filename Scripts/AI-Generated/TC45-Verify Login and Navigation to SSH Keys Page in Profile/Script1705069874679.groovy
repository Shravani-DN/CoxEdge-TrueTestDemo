...
WebUI.navigateToUrl(GlobalVariable.application_domain + '/profile/sshKeys')
...
testObj = findTestObject('AI-Generated/Page_profile_sshKeys/button_object_2')
...
WebUI.verifyMatch(WebUI.getUrl(), '.*/profile/sshKeys/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(testObj)

'step 5: At Page profile sshKeys click on li object'

testObj = findTestObject('AI-Generated/Page_profile_sshKeys/li_object')
...
'step 6: Add visual checkpoint at Page profile sshKeys'

WebUI.takeFullPageScreenshotAsCheckpoint('TC45-Verify Login and Navigation to SSH Keys Page in Profile_visual_checkpoint')
