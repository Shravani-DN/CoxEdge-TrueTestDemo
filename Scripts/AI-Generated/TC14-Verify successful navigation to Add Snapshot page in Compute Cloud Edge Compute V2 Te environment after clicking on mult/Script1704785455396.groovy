...
testObj = findTestObject('AI-Generated/Page_service_manage-workloads_compute-cloud_snapshots/button_object_3')
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC14-Verify successful navigation to Add Snapshot page in Compute Cloud Edge Compute V2 Te environment after clicking on mult_visual_checkpoint')
