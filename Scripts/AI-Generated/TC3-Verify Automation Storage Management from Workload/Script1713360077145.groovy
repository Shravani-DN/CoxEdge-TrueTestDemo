...
"Step 4: Add and manage compute cloud automation workloads"

WebUI.takeScreenshot()

addManageComputeCloudAutomationWorkloads.execute()

"Step 5: Click on p  -> Navigate to page 'service/manage-workloads/*/compute-cloud/automation/workload'"
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC3-Verify Automation Storage Management from Workload_visual_checkpoint')
