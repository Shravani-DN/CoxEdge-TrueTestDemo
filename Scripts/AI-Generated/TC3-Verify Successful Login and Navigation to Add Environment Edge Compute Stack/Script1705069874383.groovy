...
WebUI.navigateToUrl(GlobalVariable.application_domain + '/environment/add-environment/edge-compute/stackpath-cox-uat')
...
'step 4: Add visual checkpoint at Page environment add-environment edge-compute stac'

WebUI.takeFullPageScreenshotAsCheckpoint('TC3-Verify Successful Login and Navigation to Add Environment Edge Compute Stack_visual_checkpoint')
