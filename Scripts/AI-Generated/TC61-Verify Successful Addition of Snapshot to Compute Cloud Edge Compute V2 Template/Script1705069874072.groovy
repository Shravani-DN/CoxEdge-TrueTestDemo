...
testObj = findTestObject('AI-Generated/Page_add-snapshot_compute-cloud/button_object')
...
WebUI.verifyMatch(WebUI.getUrl(), '.*/add-snapshot/compute-cloud/.*/.*/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(testObj)

'step 7: Add visual checkpoint at Page add-snapshot compute-cloud edge-compute-v2 te'

WebUI.takeFullPageScreenshotAsCheckpoint('TC61-Verify Successful Addition of Snapshot to Compute Cloud Edge Compute V2 Template_visual_checkpoint')
