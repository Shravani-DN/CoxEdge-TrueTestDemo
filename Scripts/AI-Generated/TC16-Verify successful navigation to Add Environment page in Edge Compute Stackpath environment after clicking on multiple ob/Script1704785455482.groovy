...
testObj = findTestObject('AI-Generated/Page_service_edge-compute/div_object')
...
WebUI.verifyMatch(WebUI.getUrl(), '.*/service/edge-compute/.*/.*/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(testObj)

'step 7: Add visual checkpoint at Page environment add-environment edge-compute stac'

WebUI.takeFullPageScreenshotAsCheckpoint('TC16-Verify successful navigation to Add Environment page in Edge Compute Stackpath environment after clicking on multiple ob_visual_checkpoint')
