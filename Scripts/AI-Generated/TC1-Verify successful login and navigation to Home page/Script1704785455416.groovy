...
WebUI.navigateToUrl(GlobalVariable.application_domain + '/services/baremetal-services/server-type-test/servers')
...
'step 4: Add visual checkpoint at Page services baremetal-services server-type-test'

WebUI.takeFullPageScreenshotAsCheckpoint('TC1-Verify successful login and navigation to Home page_visual_checkpoint')
