...
testObj = findTestObject('AI-Generated/Page_service_manage-workloads_compute-cloud_workload/td_object')
...
'step 6: Add visual checkpoint at Page service workload-detail edge-compute-v2 compu'

WebUI.takeFullPageScreenshotAsCheckpoint('TC12-Verify successful navigation to Workload Detail page in Edge Compute V2 Compu environment after clicking on an object_visual_checkpoint')
