...
testObj = findTestObject('AI-Generated/Page_services_baremetal-services/div_object')
...
'step 5: Add visual checkpoint at Page services baremetal-services tese servers'

WebUI.takeFullPageScreenshotAsCheckpoint('TC42-Verify Login and Navigation to Baremetal Services Tese Servers Page_visual_checkpoint')
