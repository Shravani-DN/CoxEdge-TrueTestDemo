...
testObj = findTestObject('AI-Generated/Page_service_manage-workloads_compute-cloud_workload/button_object_3')
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC10-Verify successful navigation to Manage Workloads page in Edge Compute V2 Comp environment after clicking on multiple obj_visual_checkpoint')
