...
'step 7: Add visual checkpoint at Page add-workloads compute-cloud edge-compute-v2 t'

WebUI.takeFullPageScreenshotAsCheckpoint('TC15-Verify successful navigation to Add Workloads page in Compute Cloud Edge Compute V2 T environment after clicking on mult_visual_checkpoint')
