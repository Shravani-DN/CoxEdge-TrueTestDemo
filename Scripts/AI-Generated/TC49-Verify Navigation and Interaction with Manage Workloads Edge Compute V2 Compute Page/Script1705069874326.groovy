...
testObj = findTestObject('AI-Generated/Page_service_manage-workloads_compute-cloud_networks/button_object')
...
WebUI.navigateToUrl(GlobalVariable.application_domain + '/service/manage-workloads/edge-compute-v2/compute-cloud/test1/networks')

'step 7: At Page service manage-workloads edge-compute-v2 comp click on button object'

testObj = findTestObject('AI-Generated/Page_service_manage-workloads_compute-cloud_networks/button_object_1')
...
testObj = findTestObject('AI-Generated/Page_service_manage-workloads_compute-cloud_networks/span_object')
...
'step 9: Add visual checkpoint at Page service manage-workloads edge-compute-v2 comp'

WebUI.takeFullPageScreenshotAsCheckpoint('TC49-Verify Navigation and Interaction with Manage Workloads Edge Compute V2 Compute Page_visual_checkpoint')
