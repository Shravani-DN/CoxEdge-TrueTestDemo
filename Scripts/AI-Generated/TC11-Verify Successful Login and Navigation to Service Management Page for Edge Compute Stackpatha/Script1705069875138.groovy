...
WebUI.navigateToUrl(GlobalVariable.application_domain + '/service/manage-workloads/edge-compute/stackpath-cox-uat/test/workload')
...
'step 4: Add visual checkpoint at Page service manage-workloads edge-compute stackpa'

WebUI.takeFullPageScreenshotAsCheckpoint('TC11-Verify Successful Login and Navigation to Service Management Page for Edge Compute Stackpatha_visual_checkpoint')
