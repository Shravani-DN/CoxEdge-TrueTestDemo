...
WebUI.verifyElementPresent(findTestObject('AI-Generated/Page_service_manage_workloads_compute_cloud_env_automation_workload/button_ts'), 20, FailureHandling.CONTINUE_ON_FAILURE)
...
WebUI.enhancedClick(findTestObject('AI-Generated/Page_service_manage_workloads_compute_cloud_env_automation_workload/button_ts'))

"Step 5: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC73-Verify Workload in Service Manage Workloads Compute Cloud Env Automation Workload_visual_checkpoint')
