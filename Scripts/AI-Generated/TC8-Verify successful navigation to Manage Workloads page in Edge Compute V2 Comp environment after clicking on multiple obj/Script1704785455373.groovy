...
testObj = findTestObject('AI-Generated/Page_service_manage-workloads_compute-cloud_snapshots/button_object')
...
WebUI.navigateToUrl(GlobalVariable.application_domain + '/service/manage-workloads/edge-compute-v2/compute-cloud/test1/snapshots')

'step 7: At Page service manage-workloads edge-compute-v2 comp click on button object'

testObj = findTestObject('AI-Generated/Page_service_manage-workloads_compute-cloud_snapshots/button_object_1')
...
testObj = findTestObject('AI-Generated/Page_service_manage-workloads_compute-cloud_snapshots/button_object_2')
...
'step 10: Add visual checkpoint at Page service manage-workloads edge-compute-v2 comp'

WebUI.takeFullPageScreenshotAsCheckpoint('TC8-Verify successful navigation to Manage Workloads page in Edge Compute V2 Comp environment after clicking on multiple obj_visual_checkpoint')
