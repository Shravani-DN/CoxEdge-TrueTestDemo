...
testObj = findTestObject('AI-Generated/Page_service_manage-workloads_compute-cloud_workload/button_object_2')
...
testObj = findTestObject('AI-Generated/Page_add-workloads_compute-cloud/button_object')
...
WebUI.verifyMatch(WebUI.getUrl(), '.*/add-workloads/compute-cloud/.*/.*/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(testObj)

'step 6: Navigate to Page add-workloads compute-cloud edge-compute-v2 t'

WebUI.navigateToUrl(GlobalVariable.application_domain + '/add-workloads/compute-cloud/edge-compute-v2/test1')

'step 7: At Page add-workloads compute-cloud edge-compute-v2 t click on button object'

testObj = findTestObject('AI-Generated/Page_add-workloads_compute-cloud/button_object_1')
...
testObj = findTestObject('AI-Generated/Page_add-workloads_compute-cloud/button_object_2')
...
'step 9: Add visual checkpoint at Page add-workloads compute-cloud edge-compute-v2 t'

WebUI.takeFullPageScreenshotAsCheckpoint('TC22-Verify Successful Workflow for Adding Workloads to Compute Cloud Edge Compute V2 T_visual_checkpoint')
