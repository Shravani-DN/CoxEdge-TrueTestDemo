...
testObj = findTestObject('AI-Generated/Page_service_manage-workloads_compute-cloud_loadtest_workload/button_object')
...
testObj = findTestObject('AI-Generated/Page_add-workloads_compute-cloud_loadtest/button_object')
...
WebUI.verifyMatch(WebUI.getUrl(), '.*/add-workloads/compute-cloud/.*/loadtest/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(testObj)

'step 6: At Page add-workloads compute-cloud edge-compute-v2 l click on button object'

testObj = findTestObject('AI-Generated/Page_add-workloads_compute-cloud_loadtest/button_object_1')
...
'step 7: Add visual checkpoint at Page add-workloads compute-cloud edge-compute-v2 l'

WebUI.takeFullPageScreenshotAsCheckpoint('TC64-Verify Successful Addition of Workloads to Compute Cloud Edge Compute V2 L_visual_checkpoint')
