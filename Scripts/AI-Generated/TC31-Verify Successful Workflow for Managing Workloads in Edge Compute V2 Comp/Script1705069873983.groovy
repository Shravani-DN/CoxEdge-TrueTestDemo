...
testObj = findTestObject('AI-Generated/Page_service_manage-workloads_compute-cloud_workload/div_object_1')
...
'step 8: Add visual checkpoint at Page service manage-workloads edge-compute-v2 comp'

WebUI.takeFullPageScreenshotAsCheckpoint('TC31-Verify Successful Workflow for Managing Workloads in Edge Compute V2 Comp_visual_checkpoint')
