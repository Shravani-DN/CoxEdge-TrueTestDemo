...
testObj = findTestObject('AI-Generated/Page_home/button_object_9')
...
testObj = findTestObject('AI-Generated/Page_activity/button_object')
...
WebUI.verifyMatch(WebUI.getUrl(), '.*/activity/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(testObj)

'step 5: Add visual checkpoint at Page activity'

WebUI.takeFullPageScreenshotAsCheckpoint('TC44-Verify Login and Navigation to Activity Page_visual_checkpoint')
