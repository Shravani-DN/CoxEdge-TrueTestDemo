...
public class manageComputeCloudEnvAutomationWorkloads {
    ...
    private static def execute_functional_method(Map data) {
        ...
        WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '?/?(?:#.*)?(?:\\?.*)?$', true)
        WebUI.enhancedClick(findTestObject('AI-Generated/Page_home/button_ts'))
        "Step 4: Click on button 'Edge Compute 2.0' -> Navigate to page 'service/manage-workloads/*/compute-cloud/env automation/workload'"
        WebUI.takeScreenshot()
